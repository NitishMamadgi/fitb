                        ...
                        <span key={cIdx} style={{ position: "relative", margin: 0, padding: 0 }}>
                          {revealed[qIdx][cIdx] ? (
                            ...
                            <input
                              ...
                              className={`font-mono text-xs text-center outline-none transition-all ${userInputs[qIdx][cIdx] === char ? "bg-green-100 border-b-2 border-green-500" : userInputs[qIdx][cIdx] ? "bg-red-100 border-b-2 border-red-500" : "border-b-2 border-gray-400"}`}
                              style={{ width: "14px", height: "22px", margin: "0px", padding: "0px", background: "none", border: "none", borderBottom: "2px solid #bbb" }}
                            />
                          )}
                          <span
                            style={{
